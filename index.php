	...
	if (cookie_get('cms_key')) {
		...
		if (user(false, 'cms_user_id')) {
			...
			return draw_css('
				...
				body #cms_bar div.wrapper ul.cms_bar_nav li a:active { padding: 3px 9px 1px 11px; border-color: transparent; 
				...
				' . (($width != '100%') ? '
				body #cms_bar div.wrapper ul.cms_bar_nav li.last { border-right: 1px solid rgba(255,255,255,0.4);  } 
				body #cms_bar div.wrapper ul.cms_bar_nav li.last a { border-right: 1px solid rgba(0,0,0,0.3); }' : '') . '
