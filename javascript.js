...
function form_tinymce_init(cssLocation) {
	tinyMCE.init({
		...
		theme : "advanced",
		skin : "default",
		theme_advanced_buttons1 : "bold,italic,underline,strikethrough,separator,justifyleft,justifycenter,blockquote,separator,bullist,numlist,separator,undo,redo,separator,link,unlink,image,media,|,code",
		...
		plugins : "imagemanager,filemanager,media",
